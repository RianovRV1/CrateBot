...
public class CharacterController2D : MonoBehaviour 
{
    ...
    public enum Swimming // this is for controlling of use of gravity or not, in the context of water enemies
    {
        swimming,
        NotSwimming
    }
    ...
    {
        AddForce(new Vector2(0, (Parameters.JumpMagnitude * multiplier)));
    ...
    private void Move(Vector2 deltaMovement)
    {
        ...
        if (HandleCollisions)
        {
            ...
            CorrrectHorizontalPlacement(ref deltaMovement, true);
            CorrrectHorizontalPlacement(ref deltaMovement, false);
    ...
    private void CorrrectHorizontalPlacement(ref Vector2 deltaMovement, bool isRight)
    {
